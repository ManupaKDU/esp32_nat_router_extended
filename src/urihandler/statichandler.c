...
esp_err_t styles_download_get_handler(httpd_req_t *req)
{
    ...
    const size_t styles_size = (size_t)(styles_end - styles_start) - 1;
...
esp_err_t jquery_get_handler(httpd_req_t *req)
{
    ...
    const size_t jquery_js_size = (size_t)(jquery_js_end - jquery_js_start) - 1;
...
esp_err_t reset_get_handler(httpd_req_t *req)
{
    ...
    const size_t reset_size = (size_t)(reset_end - reset_start) - 1;
